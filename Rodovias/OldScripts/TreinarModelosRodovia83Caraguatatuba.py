...
RODOVIA_ALVO = "Doutor Manoel Hyppolito Rego, KM 83 — Caraguatatuba (SP)."
PASTA_SAIDA = r"modelos_rodovias\doutor_manoel_hyppolito_rego_km_83_caraguatatuba_sp_rf_regimes"
...
def preparar_base(df):
    ...
    if "rodovia_identificacao" in df.columns:
        ...
        df = df[df["rodovia"].astype(str).str.contains("Doutor Manoel Hyppolito Rego", case=False, na=False)].copy()
